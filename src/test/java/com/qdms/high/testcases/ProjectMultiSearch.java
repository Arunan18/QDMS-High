...
//		Method.checkBeforeSearchData("Project",1, ProjectSearchPage.CodeColumn,ProjectSearchPage.CodeColumnBefore,ProjectSearchPage.CodeColumnAfter,"Project - Code");
...
//		STEP 5 : Project - Code Search Data Input
		Method.inputDataSearch(ProjectSearchPage.SearchTextBox, "STEP 5 : Project - Code");  
...
//		STEP 7 : Project - Code Single Search Function
		Method.checkAfterSearchData(ProjectSearchPage.CodeColumn, ProjectSearchPage.CodeColumnBefore, ProjectSearchPage.CodeColumnAfter,  CodeTableData, "STEP 7 : Project - Code");
		
//		STEP 8 : Project - Plant Search Button Properties
		Method.checkSearch(ProjectSearchPage.PlantSearch,"STEP 8 : Project - Plant");
		
		Method.checkBeforeSearchData("Project",2, ProjectSearchPage.PlantColumn,ProjectSearchPage.PlantColumnBefore,ProjectSearchPage.PlantColumnAfter, "Project - Plant");
...
//		STEP 12 : Project - Plant Search Data Input
		Method.inputDataSearch(ProjectSearchPage.SearchTextBox, "STEP 12 : Project - Plant");
...
//		STEP 14 : Project - Plant Single Search Function
		Method.checkAfterSearchData(ProjectSearchPage.PlantColumn, ProjectSearchPage.PlantColumnBefore, ProjectSearchPage.PlantColumnAfter, PlantTableData, "STEP 14 : Project - Plant");
...
//		STEP 15 : Project - Project Search Button Properties
		...
		Method.checkBeforeSearchData("Project",3, ProjectSearchPage.ProjectColumn,ProjectSearchPage.ProjectColumnBefore,ProjectSearchPage.ProjectColumnAfter,"Project - Project");
...
//		STEP 19 : Project - Project Search Data Input
		Method.inputDataSearch(ProjectSearchPage.SearchTextBox, "STEP 19 : Project - Project");
...
//		STEP 21 : Project - Project Single Search Function
		Method.checkAfterSearchData(ProjectSearchPage.ProjectColumn, ProjectSearchPage.ProjectColumnBefore, ProjectSearchPage.ProjectColumnAfter,  ProjectTableData, "STEP 21 : Project - Project");
...
//		STEP 22 : Project - Customer Search Button Properties
		...
		Method.checkBeforeSearchData("Project",4, ProjectSearchPage.CustomerColumn,ProjectSearchPage.CustomerColumnBefore,ProjectSearchPage.CustomerColumnAfter,"Project - Customer");
...
//		STEP 26 : Project - Customer Search Data Input
		Method.inputDataSearch(ProjectSearchPage.SearchTextBox, "STEP 26 : Project - Customer");
...
//		STEP 28 : Project - Customer Single Search Function
		Method.checkAfterSearchData(ProjectSearchPage.CustomerColumn, ProjectSearchPage.CustomerColumnBefore, ProjectSearchPage.CustomerColumnAfter, CustomerTableData, "STEP 28 : Project - Customer");
...
//		STEP 29 : Project - Contact Person Search Button Properties
		...
		Method.checkBeforeSearchData("Project",5, ProjectSearchPage.ContactPersonColumn,ProjectSearchPage.ContactPersonColumnBefore,ProjectSearchPage.ContactPersonColumnAfter,"Project - Contact Person");
...
//		STEP 33 : Project - Contact Person Search Data Input
		Method.inputDataSearch(ProjectSearchPage.SearchTextBox, "STEP 33 : Project - Contact Person");
...
//		STEP 35 : Project - Contact Person Single Search Function
		Method.checkAfterSearchData(ProjectSearchPage.ContactPersonColumn, ProjectSearchPage.ContactPersonColumnBefore, ProjectSearchPage.ContactPersonColumnAfter,  ContactPersonTableData, "STEP 35 : Project - Contact Person");
...
//		STEP 36 : Project - Contact No Search Button Properties
		...
		Method.checkBeforeSearchData("Project",6, ProjectSearchPage.ContactNoColumn,ProjectSearchPage.ContactNoColumnBefore,ProjectSearchPage.ContactNoColumnAfter,"Project - Contact No");
...
//		STEP 40 : Project - Contact No Search Data Input
		Method.inputDataSearch(ProjectSearchPage.SearchTextBox, "STEP 40 : Project - Contact No");
...
//		STEP 42 : Project - Contact No Single Search Function
		Method.checkAfterSearchData(ProjectSearchPage.ContactNoColumn, ProjectSearchPage.ContactNoColumnBefore, ProjectSearchPage.ContactNoColumnAfter,  ContactNoTableData, "STEP 42 : Project - Contact No");
		
//		STEP 43 : Project - Date Search Button Properties
		Method.checkSearch(ProjectSearchPage.DateSearch,"STEP 43 : Project - Date");
		
		Method.checkBeforeSearchData("Project",6, ProjectSearchPage.DateColumn,ProjectSearchPage.DateColumnBefore,ProjectSearchPage.DateColumnAfter,"Project - Contact No");
...
//		STEP 47 : Project - Date Search Data Input
		Method.inputDataSearch(ProjectSearchPage.SearchTextBox, "STEP 47 : Project - Date");
...
//		STEP 49 : Project - Date Single Search Function
		Method.checkAfterSearchData(ProjectSearchPage.DateColumn, ProjectSearchPage.DateColumnBefore, ProjectSearchPage.DateColumnAfter,  DateTableData, "STEP 49 : Project - Date");
