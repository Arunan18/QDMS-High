...
//		STEP 5 : Customer - Customer Name Search Data Input
		Method.inputDataSearch(CustomerSearchPage.SearchTextBox, "STEP 5 : Customer - Customer Name","Customer",1, CustomerSearchPage.CustomerColumn); 
...
//		STEP 7 : Customer - Customer Name Single Search Function
		Method.checkAfterSearchData(CustomerSearchPage.CustomerColumn, CustomerSearchPage.CustomerColumnBefore, CustomerSearchPage.CustomerColumnAfter,  CustomerTableData, "STEP 7 : Customer - Customer Name",1);
...
//		STEP 12 : Customer - Plant Search Data Input
		Method.inputDataSearch(CustomerSearchPage.SearchTextBox, "STEP 12 : Customer - Plant","Customer",2, CustomerSearchPage.PlantColumn);
...
//		STEP 14 : Customer - Plant Single Search Function
		Method.checkAfterSearchData(CustomerSearchPage.PlantColumn, CustomerSearchPage.PlantColumnBefore, CustomerSearchPage.PlantColumnAfter, PlantTableData, "STEP 14 : Customer - Plant",1);
...
//		STEP 19 : Customer - Email Search Data Input
		Method.inputDataSearch(CustomerSearchPage.SearchTextBox, "STEP 19 : Customer - Email","Customer",3, CustomerSearchPage.EmailColumn);
...
//		STEP 21 : Customer - Email Single Search Function
		Method.checkAfterSearchData(CustomerSearchPage.EmailColumn, CustomerSearchPage.EmailColumnBefore, CustomerSearchPage.EmailColumnAfter,  EmailTableData, "STEP 21 : Customer - Email",1);
...
//		STEP 26 : Customer - Contact No Search Data Input
		Method.inputDataSearch(CustomerSearchPage.SearchTextBox, "STEP 26 : Customer - Contact No","Customer",4, CustomerSearchPage.ContactNoColumn);
...
//		STEP 28 : Customer - Contact No Single Search Function
		Method.checkAfterSearchData(CustomerSearchPage.ContactNoColumn, CustomerSearchPage.ContactNoColumnBefore, CustomerSearchPage.ContactNoColumnAfter, ContactNoTableData, "STEP 28 : Customer - Contact No",1);
