...
//		STEP 1 : Delivery - Delivery Name Search Button Properties
		...
		Thread.sleep(2000);
		Method.checkBeforeSearchData("Delivery", 1, DeliveryPage.DeleveryColumn,
				DeliveryPage.DeleveryColumnBefore, DeliveryPage.DeleveryColumnAfter,
				"Delivery - Delivery Name");

//		STEP 2 : Delivery - Delivery Name Search Icon Click
		Method.ClickSearch(DeliveryPage.DeleverySearch, DeliveryPage.SearchTextBox,
				"STEP 2 : Delivery - Delivery Name");
...
//		STEP 5 : Delivery - Delivery Name Search Data Input
		Method.inputDataSearch(DeliveryPage.SearchTextBox, "STEP 5 : Delivery - Delivery Name");

//		STEP 6 : Delivery - Delivery Name Search Button Click
		Method.SearchButtonClick(DeliveryPage.SearchBtn, DeliveryPage.ResetAll,
				"STEP 6 : Delivery - Delivery Name");

//		STEP 7 : Delivery - Delivery Name Single Search Function
		Method.checkAfterSearchData(DeliveryPage.DeleveryColumn, DeliveryPage.DeleveryColumnBefore,
				DeliveryPage.DeleveryColumnAfter, DeliveryTableData, "STEP 7 : Delivery - Delivery Name");
...
//		STEP 8 : Delivery - Project Name Search Button Properties
		...
		Method.checkBeforeSearchData("Delivery", 2, DeliveryPage.ProjectColumn,
				DeliveryPage.ProjectColumnBefore, DeliveryPage.ProjectColumnAfter,
				"Delivery - Project Name");

//		STEP 9 : Delivery - Project Name Search Icon Click
		Method.ClickSearch(DeliveryPage.ProjectSearch, DeliveryPage.SearchTextBox,
				"STEP 9 : Delivery - Project Name");
...
//		STEP 12 : Delivery - Project Name Search Data Input
		Method.inputDataSearch(DeliveryPage.SearchTextBox, "STEP 12 : Delivery - Project Name");
...
//		STEP 14 : Delivery - Project Name Single Search Function
		Method.checkAfterSearchData(DeliveryPage.ProjectColumn, DeliveryPage.ProjectColumnBefore,
				DeliveryPage.ProjectColumnAfter, ProjectTableData, "STEP 14 : Delivery - Project Name");
