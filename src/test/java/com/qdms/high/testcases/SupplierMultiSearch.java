...
//		STEP 5 : Supplier - Supplier Name Search Data Input
		Method.inputDataSearch(SupplierSearchPage.SearchTextBox, "STEP 5 : Supplier - Supplier Name","Supplier",1, SupplierSearchPage.SupplierColumn); 
...
//		STEP 7 : Supplier - Supplier Name Single Search Function
		Method.checkAfterSearchData(SupplierSearchPage.SupplierColumn, SupplierSearchPage.SupplierColumnBefore, SupplierSearchPage.SupplierColumnAfter,  SupplierTableData, "STEP 7 : Supplier - Supplier Name",1);
...
//		STEP 12 : Supplier - Plant Search Data Input
		Method.inputDataSearch(SupplierSearchPage.SearchTextBox, "STEP 12 : Supplier - Plant","Supplier",2, SupplierSearchPage.PlantColumn);
...
//		STEP 14 : Supplier - Plant Single Search Function
		Method.checkAfterSearchData(SupplierSearchPage.PlantColumn, SupplierSearchPage.PlantColumnBefore, SupplierSearchPage.PlantColumnAfter, PlantTableData, "STEP 14 : Supplier - Plant",1);
...
//		STEP 19 : Supplier - Email Search Data Input
		Method.inputDataSearch(SupplierSearchPage.SearchTextBox, "STEP 19 : Supplier - Email","Supplier",3, SupplierSearchPage.EmailColumn);
...
//		STEP 21 : Supplier - Email Single Search Function
		Method.checkAfterSearchData(SupplierSearchPage.EmailColumn, SupplierSearchPage.EmailColumnBefore, SupplierSearchPage.EmailColumnAfter,  EmailTableData, "STEP 21 : Supplier - Email",1);
...
//		STEP 26 : Supplier - Contact No Search Data Input
		Method.inputDataSearch(SupplierSearchPage.SearchTextBox, "STEP 26 : Supplier - Contact No","Supplier",4, SupplierSearchPage.ContactNoColumn);
...
//		STEP 28 : Supplier - Contact No Single Search Function
		Method.checkAfterSearchData(SupplierSearchPage.ContactNoColumn, SupplierSearchPage.ContactNoColumnBefore, SupplierSearchPage.ContactNoColumnAfter, ContactNoTableData, "STEP 28 : Supplier - Contact No",1);
...
//		STEP 33 : Supplier - Address Search Data Input
		Method.inputDataSearch(SupplierSearchPage.SearchTextBox, "STEP 33 : Supplier - Address","Supplier",5, SupplierSearchPage.AddressColumn);
...
//		STEP 35 : Supplier - Address Single Search Function
		Method.checkAfterSearchData(SupplierSearchPage.AddressColumn, SupplierSearchPage.AddressColumnBefore, SupplierSearchPage.AddressColumnAfter,  AddressTableData, "STEP 35 : Supplier - Address",1);
...
//		STEP 40 : Supplier - Supplier Category Search Data Input
		Method.inputDataSearch(SupplierSearchPage.SearchTextBox, "STEP 40 : Supplier - Supplier Category","Supplier",6, SupplierSearchPage.SupplierCategoryColumn);
...
//		STEP 42 : Supplier - Supplier Category Single Search Function
		Method.checkAfterSearchData(SupplierSearchPage.SupplierCategoryColumn, SupplierSearchPage.SupplierCategoryColumnBefore, SupplierSearchPage.SupplierCategoryColumnAfter,  SupplierCategoryTableData, "STEP 42 : Supplier - Supplier Category",1);
		
		
//		STEP 43 : Supplier Multi Search (Check Correct Data Count Filter) ☑ 
